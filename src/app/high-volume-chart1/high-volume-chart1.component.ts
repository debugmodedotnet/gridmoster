...
@Component({
  selector: 'app-high-volume-chart1',
  templateUrl: './high-volume-chart1.component.html',
  styleUrls: ['./high-volume-chart1.component.css']
})
export class HighVolumeChart1Component {
