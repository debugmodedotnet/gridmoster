...
@Component({
  selector: 'app-monster-grid1',
  templateUrl: './monster-grid1.component.html',
  styleUrls: ['./monster-grid1.component.scss']
})
export class MonsterGrid1Component implements OnInit, AfterViewInit {
